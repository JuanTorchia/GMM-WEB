    ...
    <div class="p-a-md box-color r box-shadow-z1 text-color m-a">
      ...
      <form name="form" method="post">
        <div class="md-form-group float-label">
          <input id="email" type="email" class="md-input" name="user_email" ng-model="user.email" required>
          <label>Email</label>
        </div>
        <div class="md-form-group float-label">
          <input id="password" name="user_password" type="password" class="md-input" ng-model="user.password" required>
